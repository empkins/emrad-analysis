...
poetry run python main.py --epochs 50 --learning_rate 0.0001 --image_based True --datasource radarcadia --breathing_type all --label_type gaussian --dual_channel False --log True --wavelet gaus1 --loss mse
...
poetry run python main.py --epochs 50 --learning_rate 0.0001 --image_based True --datasource radarcadia --breathing_type all --label_type gaussian --dual_channel False --log True --wavelet morl --identity True
