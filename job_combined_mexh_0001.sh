#!/bin/bash -l
#
#SBATCH --job-name=uNetCombinedMexh_40Epochs0001
#SBATCH --nodes=1
...
poetry run python main.py --epochs 40 --learning_rate 0.0001 --image_based False --log False --label_type gaussian --dual_channel False --wavelet mexh --combined True
